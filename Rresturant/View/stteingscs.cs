...
namespace Rresturant
{
    public partial class stteingscs : Form
    {
        ...
        private void buttonAddingNewCustomer_Click(object sender , EventArgs e)
        {
            get_all_IDs ();
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter ( "@CustomerID" , SqlDbType.Int );
            param[1] = new SqlParameter ( "@CustomerName" , SqlDbType.NVarChar , 250 );
            param[2] = new SqlParameter ( "@CustomerAddress" , SqlDbType.NVarChar , 250 );
            param[3] = new SqlParameter ( "@CustomerMobile" , SqlDbType.NVarChar , 250 );
            param[4] = new SqlParameter ( "@EnteredUSer" , SqlDbType.NVarChar , 250 );
            param[0].Value = UserID;
            param[1].Value = textBoxNewCustomerName.Text;
            if ( textBoxNewCustomerAdd.Text == "" )
            {
                textBoxNewCustomerAdd.Text = "لايوجد";
            }
            if ( textBoxNewCustomerMobile.Text == "" )
            {
                textBoxNewCustomerMobile.Text = "لايوجد";
            }
            param[2].Value = textBoxNewCustomerAdd.Text;
            param[3].Value = textBoxNewCustomerMobile.Text;
            param[4].Value = "Mustafa";
            usedClass.ExecuteCommand ( "Seetings_insertNewCustomer" , param );
            MessageBox.Show ( "تمت الاضافة بنجاح" , "أضـــافة" , MessageBoxButtons.OK , MessageBoxIcon.Information );
